...
from craftbot.utils import is_admin
...
def delay(ms, jitter=0.05):
    """
    approximate delay
    default delay:[1, (1+jitter)] * ms

    Args:
        ms: milli-sec
        jitter: percentage of approximation
    """
    time.sleep((ms + randint(0, int(ms * jitter))) / 1000)
